			...
			>
				<div className="bg-white h-[100%] rounded-t-2xl">
					<div className="flex flex-row justify-around w-[100%] text-stone-500 font-monospace text-[0px] sm:text-lg">
						<div className="w-4/12 h-10 flex justify-center items-center bg-white rounded-tl-2xl">
							Parlour.tsx
						</div>
						<div className="w-4/12 h-10 flex justify-center items-center bg-[#f5f5f5] border-x-[1px] border-stone-200">
							Script.py
						</div>
						<div className="w-4/12 h-10 flex justify-center items-center bg-[#f5f5f5] rounded-tr-2xl">
							Less.go
						</div>
					</div>
