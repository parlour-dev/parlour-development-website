				...
				<div className="flex flex-col lg:flex-row gap-8 mt-16 justify-center relative z-30">
					<div className="flex flex-col gap-8 w-96 ">
						<div
							...
							className="flex flex-col items-center justify-between bg-white text-center min-h-96 rounded-3xl lg:min-h-[35rem] border-2 border-x-blue-500 border-y-sky-500 shadow-lg shadow-blue-500/20"
						>
							<img
							...
							<div className="h-24 w-full px-8 rounded-b-3xl">
								...
								<div className=" text-xl text-left justify-center ">
									Create a Web3 experience and make you users fall in love with
									it.
								</div>
							</div>
						...
						<div
							...
							data-aos-delay="1500"
							data-aos-offset="-200"
							className="flex flex-col items-center justify-between row-start-2 text-neutral-400 bg-white text-center  h-[32rem] rounded-3xl relative border-[1px] border-stone-600"
						>
					...
					<div className="flex flex-col gap-8 w-96 ">
						<div
							...
							data-aos-duration="800"
							data-aos-delay="400"
							className="flex flex-col items-center justify-between bg-white text-center h-[38rem] rounded-3xl border-2 border-y-orange-400 border-x-orange-500 shadow-lg shadow-orange-500/20"
						>
							<img
							...
							<div className="w-full px-8 mb-6 rounded-b-3xl">
								...
								<div className="text-xl text-left justify-center ">
									Launch a stunning NFT collection and give it endless utility.
								</div>
							</div>
						...
						<div
							...
							data-aos-delay="950"
							data-aos-offset="-200"
							className="flex flex-col items-center justify-between bg-white text-center lg:h-[29rem] h-96 rounded-3xl relative border-2 border-x-purple-500   border-y-violet-500 shadow-lg shadow-violet-500/20"
						>
							<img
					...
					<div className="flex flex-col gap-8 w-96 ">
						<div
							...
							data-aos-duration="800"
							data-aos-delay="800"
							className="flex flex-col items-center justify-between bg-white  text-center lg:h-[33rem] h-96 rounded-3xl relative border-2 border-x-lime-400 border-y-green-400 shadow-lg shadow-lime-500/20"
						>
							<img
						...
						<div
							...
							data-aos-delay="650"
							data-aos-offset="-200"
							className="flex flex-col items-center justify-between bg-white text-center h-96 lg:h-[34rem] rounded-3xl relative border-2 border-x-pink-500 border-y-red-500 shadow-lg shadow-pink-500/20"
						>
							<img
				...
				<div className="flex flex-col mt-16 mx-auto w-[85%] xs:w-[95%] gap-8 justify-center items-center">
					<div className="flex flex-col gap-8 w-[95%] max-w-[25rem] md:max-w-[100%] md:w-96 ">
						<div
							data-aos="zoom-in-right"
							data-aos-duration="800"
							className="flex flex-col items-center justify-between bg-white text-center h-[28rem] rounded-3xl border-2 border-x-blue-500 border-y-sky-500 shadow-lg shadow-blue-500/20"
						>
							<img
						...
						<div
							data-aos="zoom-in-left"
							data-aos-duration="800"
							className="flex flex-col items-center justify-between bg-white text-center h-[30rem] rounded-3xl border-2 border-x-purple-500   border-y-violet-500 shadow-lg shadow-violet-500/20"
						>
							<img
					...
					<div
							data-aos="zoom-in-right"
							data-aos-duration="800"
							className="flex flex-col items-center justify-between bg-white text-center h-[28rem] rounded-3xl border-2 border-y-orange-400 border-x-orange-500 shadow-lg shadow-orange-500/20"
						>
							<img
								className="w-[60%] mt-10 mx-auto mb-4"
								src={NFT}
						...
						<div
							data-aos="zoom-in-left"
							data-aos-duration="800"
							className="flex flex-col items-center justify-between bg-white text-center h-[28rem] rounded-3xl border-2 border-x-pink-500 border-y-red-500 shadow-lg shadow-pink-500/20"
						>
							<img
								className="w-[60%] mt-10 mx-auto mb-4"
								src={DeFi}
					...
					<div
							data-aos="zoom-in-right"
							data-aos-duration="800"
							className="flex flex-col items-center justify-between bg-white text-center h-[28rem] rounded-3xl border-2 border-x-lime-400 border-y-green-400 shadow-lg shadow-lime-500/20"
						>
							<img
								className="w-[60%] mt-10 mx-auto mb-4"
								src={Token}
