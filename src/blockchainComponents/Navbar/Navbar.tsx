...
import "../../components/Navbar/width.css"
...
const Navbar = () => {
	...
	return (
		<div style={{top: visible ? '0' : '-10rem', opacity: visible ? "100%" : "0%", }} className="extraWeirdWidth w-auto h-36 md:h-20 bg-[#1d1d1d] rounded-2xl mx-4 my-4 drop-shadow-sm flex items-center md:justify-between justify-center flex-col md:flex-row fixed z-50 transition-all duration-500">
			<Link to="/blockchain">
				<img
